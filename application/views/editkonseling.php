                              ...
                              <div class="col-lg-12">
                                ...
                                <div class="p-20">
                                  <table class="table table-bordered">
                                    <thead>
                                      <th style="border: 0px;">Riwayat Keluhan</th>
                                    </thead>
                                  </thead>
                                  <thead>
                                  ...
                                  <tbody>
                                    <?php foreach ($keluhan as $b): ?>
                                      ...
                                      <td style="text-align: center"><?php echo $b->namapasien; ?></td>
                                      <td style="text-align: center"><?php echo $b->tanggalpmr; ?></td>
                                      <td style="text-align: center"><?php echo $b->keluhan; ?></td>
                                      <td style="text-align: center"><?php echo $b->observasi; ?></td>
                                    <?php endforeach; ?>
                                  </tbody>
                                  </table>
                                </div>
                              ...
                              <div class="col-lg-12">
                                ...
                                <div class="p-20">
                                  <div class="form-group row" style="text-align: right">
                                    ...
                                    <div class="col-sm-5">
                                      <input type="text" name="nopmr" parsley-trigger="change" readonly value="<?php echo $a->nopmr; ?>" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                  ...
                                  <div class="form-group row" style="text-align: right">
                                    ...
                                    <div class="col-sm-5">
                                      <textarea name="keluhan" rows="3" cols="58" placeholder="Masukkan Keluhan"></textarea>
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Observasi" class="col-sm-4 form-control-label">Observasi <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <textarea name="observasi" rows="3" cols="58" placeholder="Masukkan Observasi"></textarea>
                                    </div>
                                  </div>
                                </div>
              ...
              for (var i = 0; i < data1.length; i++) {
                var html  = '<table class="table table-striped table-bordered" style="width:68%;margin-left:15%;">';
                    ...
                    if (data2 == '') {
                          ...
                          html += '<th style="text-align: center">Observasi</th>';
                          html += '</thead>';
                          html += '<tbody>';
                          html += '<tr>';
                          ...
                          html += '<td style="text-align: center">'+data2[b].observasi+'</td>';
                          html += '</tr>';
                        }
                          html += '</tbody>';
