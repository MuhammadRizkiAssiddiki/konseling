          ...
          <div class="content-page">
              ...
              <div class="content">
                  <div class="container">
                      ...
                      <!-- end row -->
                      <form enctype="multipart/form-data" role="form" action="<?php echo site_url('pasien/prosestambahpasien'); ?>" method="post">
                      <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <p class="text-muted font-13 m-b-10">
                                  Note : Silahkan Pilih/Masukkan Data Orang Tua Terlebih Dahulu, Setelah itu baru masukkan data pasien!
                                </p>
                                <div class="p-20">
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Pilih Ortu" class="col-sm-4 form-control-label">Pilih Data Orang Tua <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <select class="form-control" id="pilihortu" name="pilihortu">
                                        <option value="">--Silahkan Masukkan Pilihan--</option>
                                        <option value="1">Pilih Dari Daftar Yang Sudah Ada</option>
                                        <option value="2">Buat Data Orang Tua Baru</option>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right" id="tampilortu" hidden="hidden">
                                    <label for="Pilih Daftar" class="col-sm-4 form-control-label">Pilih Orang Tua <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <select class="form-control" id="daftarortu" name="daftarortu">
                                        <option value="">--Silahkan Pilih Data Orang Tua--</option>
                                      </select>
                                    </div>
                                  </div>
                                  <div id="getortu">
                              ...
                              <div class="col-lg-12">
                                ...
                                <div class="p-20">
                                  <div class="form-group row" style="text-align: right">
                                    ...
                                    <div class="col-sm-5">
                                      <input type="text" id="idpasien" name="idpasien" parsley-trigger="change" required placeholder="Masukkan ID Pasien" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Kode Pesanan" class="col-sm-4 form-control-label">Nama Pasien <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <input type="text" id="namapasien" name="namapasien" parsley-trigger="change" required placeholder="Masukkan ID Pasien" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Kode Pesanan" class="col-sm-4 form-control-label">Tempat Lahir <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <input type="text" name="tempatlahir" parsley-trigger="change" required placeholder="Masukkan Tempat Lahir Pasien" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    ...
                                    <div class="col-sm-5">
                                      <div class="input-group">
                                        <input type="text" name="tanggallahir" parsley-trigger="change" required placeholder="mm/dd/yyyy" class="form-control" id="datepicker-autoclose">
                                  ...
                                  <div class="form-group row" style="text-align: right">
                                    ...
                                    <div class="col-sm-5">
                                      <input type="text" name="umur" parsley-trigger="change" required placeholder="Masukkan Umur Pasien" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Alamat" class="col-sm-4 form-control-label">Alamat <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <textarea name="alamat" rows="3" cols="46" placeholder="Masukkan Alamat Pasien"></textarea>
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Kode Pesanan" class="col-sm-4 form-control-label">No HP/Telp <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <input type="text" name="notelp" parsley-trigger="change" required placeholder="Masukkan No HP/Telp" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Kode Pesanan" class="col-sm-4 form-control-label">Anak Ke <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <input type="text" name="anakke" parsley-trigger="change" required placeholder="Masukkan Anak Ke" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Kode Pesanan" class="col-sm-4 form-control-label">Sekolah <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <input type="text" name="sekolah" parsley-trigger="change" required placeholder="Masukkan Sekolah Pasien" class="form-control" id="userName">
                                    </div>
                                  </div>
                                  <div class="form-group row" style="text-align: right">
                                    <label for="Kode Pesanan" class="col-sm-4 form-control-label">Password <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                      <input type="text" name="password" parsley-trigger="change" required placeholder="Masukkan Password Pasien" class="form-control" id="userName">
                                    </div>
                                  </div>
                                </div>
          ...
          $('#pilihortu').change(function() {
            ...
            if (id==1) {
              ...
              var html = '<div class="form-group row" style="text-align: right">';
                  ...
                  html += '<div class="col-sm-5">';
                  html += '<input type="text" name="umurortu" parsley-trigger="change" required placeholder="Masukkan Umur Orang Tua" class="form-control">'
                  html += '</div>';
                  html += '</div>';
            ...
            $.ajax({
              ...
              success: function(data){
                ...
                var html = '<div class="form-group row" style="text-align: right">';
                    ...
                    html += '<label for="Umur Orang Tua" class="col-sm-4 form-control-label">Umur <span class="text-danger">*</span></label>';
                    html += '<div class="col-sm-5">';
                    html += '<input type="text" value='+'"'+data[i].umurortu+'"'+' name="umurortu" parsley-trigger="change" readonly class="form-control">'
                    html += '</div>';
                    html += '</div>';
